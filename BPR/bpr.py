...
train_data_file = data_dir+"/train_data.pickle"
valid_data_file = data_dir+"/valid_data.pickle"
test_data_file = data_dir+"/test_data.pickle"
...
train_df[ratings_col], train_df[users_col], 
